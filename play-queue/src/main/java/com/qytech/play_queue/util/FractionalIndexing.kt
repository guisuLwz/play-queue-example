package com.qytech.play_queue.util
...
object FractionalIndexing {
    ...
    // note that this may return null, as there is the largest integer
    /**
     * @param {string} x
     * @param {string} digits
     * @return {string | null}
    ...
    // note that this may return null, as there is the smallest integer
    /**
     * @param {string} x
     * @param {string} digits
     * @return {string | null}
